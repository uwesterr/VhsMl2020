...
```{r CorMap, echo=FALSE, message=FALSE, warning=FALSE}
...
One way of condensing many dimensions into just two or three are dimension reductions techniques such as principle components analysis (PCA)
