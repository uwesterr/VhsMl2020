...
# Machine leanring classes {#machineLearningClasses} 
...
- Reinforcement learning
 ...
 ![](images/classesOfLearningProblems.png){width=60% } 
...
The strategy is that the policy should choose an action that maximiyes future reward
