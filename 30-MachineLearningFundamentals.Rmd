...
For numerical features it is straight forward for them to be fed into a model, but how can categorical data be handled?
...
- Are clipped at on the low/or high end of range
...
can be shaped to be closely normally distributed as shown below.
...
![Figure from <a href="//commons.wikimedia.org/wiki/User:Nicoguaro" title="User:Nicoguaro">Nicoguaro</a> - <span class="int-own-work" lang="en">Own work</span>, <a href="https://creativecommons.org/licenses/by/4.0" title="Creative Commons Attribution 4.0">CC BY 4.0</a>, <a href="https://commons.wikimedia.org/w/index.php?curid=46871195">Link</a> [@FeatureEngineeringKuhnWebsite]](images/GaussianScatterPCA.svg){width=60% .external}
